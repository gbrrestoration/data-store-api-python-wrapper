...
class CollectionFormatAuthor(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            'email': (str,),  # noqa: E501
            'organisation': (CollectionFormatOrganisation,),  # noqa: E501
            'orcid': (str,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, email, organisation, *args, **kwargs):  # noqa: E501
        """CollectionFormatAuthor - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, email, organisation, *args, **kwargs):  # noqa: E501
        """CollectionFormatAuthor - a model defined in OpenAPI
