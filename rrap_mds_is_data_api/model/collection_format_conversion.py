...
class CollectionFormatConversion(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, handle, collection_format, s3, created_time, updated_time, *args, **kwargs):  # noqa: E501
        """CollectionFormatConversion - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, handle, collection_format, s3, created_time, updated_time, *args, **kwargs):  # noqa: E501
        """CollectionFormatConversion - a model defined in OpenAPI
